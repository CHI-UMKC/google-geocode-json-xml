...
These notes show a JSON Google Geocoding example using R.  See [Google info about geocoding with JSON output](https://developers.google.com/maps/documentation/geocoding/).
...
components["establishment", "short"]
```
...
data.frame(id, 
           ...
           establishment=components["establishment", "short"],
           types=types,
